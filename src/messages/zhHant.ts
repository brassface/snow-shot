export const zhHant = {
	...
	"settings.systemSettings.appInfo": "應用資訊",
	...
	"about.subtitle": "基於 Snow Shot 精簡的截圖工具 ❄️",
	"about.disclaimer":
		"社區 fork 版本，非 Snow Shot 官方項目，與上游作者無隸屬關係。",
	"about.version": "版本",
	"about.maintainer": "維護者: brassface",
	"about.upstream": "上游: Snow Shot",
	"about.license.title": "📄 開源協議",
	"about.license.description":
		"本項目基於 Snow Shot 修改分發，沿用上游雙重許可模式：",
	...
	"about.license.forkNotice":
		"修改後的衍生作品須遵循 GPL-3.0 開源，並保留上游 {upstream} 的版權聲明。",
	"about.contact.title": "📞 問題反饋與聯繫",
	"about.contact.github": "GitHub Issue（本項目）",
	"about.contact.repository": "本項目倉庫",
	"about.contact.upstream": "上游 Snow Shot（{author}）",
	"common.edit": "編輯",
	"common.delete": "刪除",
	"common.delete.tip": "確定刪除「{name}」嗎？",
	"common.newVersion":
		"Snow Shot Mini 新版本 {latestVersion} 已發布 \n當前版本 {currentVersion}",
	...
	"common.newVersion.updateReady.description":
		"Snow Shot Mini {version} 已準備就緒，是否立即重新啟動應用程式進行更新？",
