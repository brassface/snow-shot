export const en = {
	...
	"settings.systemSettings.appInfo": "App Info",
	...
	"about.title": "Snow Shot Mini",
	"about.subtitle": "A lightweight screenshot fork based on Snow Shot ❄️",
	"about.disclaimer":
		"Community fork — not an official Snow Shot release and not affiliated with the upstream author.",
	"about.version": "Version",
	"about.maintainer": "Maintainer: brassface",
	"about.upstream": "Upstream: Snow Shot",
	"about.license.title": "📄 Open Source License",
	"about.license.description":
		"This project is a modified distribution of Snow Shot and follows the upstream dual licensing model:",
	...
	"about.license.forkNotice":
		"Derivative works must comply with GPL-3.0 and retain upstream copyright notices from {upstream}.",
	"about.contact.title": "📞 Feedback & Contact",
	"about.contact.github": "GitHub Issue (this project)",
	"about.contact.repository": "This repository",
	"about.contact.upstream": "Upstream Snow Shot ({author})",
	"common.edit": "Edit",
	"common.delete": "Delete",
	"common.delete.tip": 'Are you sure you want to delete "{name}"?',
	"common.newVersion":
		"Snow Shot Mini version {latestVersion} has been released \nCurrent version {currentVersion}",
	...
	"common.newVersion.updateReady.description":
		"Snow Shot Mini {version} is ready. Would you like to restart the app now to install the update?",
